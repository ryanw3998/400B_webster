...
class MassProfile:
    ...
    #  snap :  integer, e.g  1
        ...
        ilbl = ilbl[-3:]
        # create filenames
        self.filename="%s_"%(galaxy)+"VLowRes/"+"%s_"%(galaxy) + ilbl + '.txt'
    ...
    def CircularVelocity(self, ptype, R,VolDec):
    ...
    # NOTE: this method assumes spherical symmetry - but the disk is not spherically symmetric.
        ...
        Menc = self.MassEnclosed(ptype,R,VolDec)
    ...
    def CircularVelocityTotal(self, R,VolDec):
    ...
    # Returns: An Array of Circular speends in units of km/s
        ...
        Menc = self.MassEnclosedTotal(R,VolDec)
