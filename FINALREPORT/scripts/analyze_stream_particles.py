...
MW_data = np.genfromtxt('{}MW_wrt_M31_data.txt'.format(master_path),dtype=None,names=True)
M31_data = np.genfromtxt('{}M31_pos_data.txt'.format(master_path),dtype=None,names=True)
MMWM31COM_pos_data = np.genfromtxt('{}MWM31COM_wrt_M31_data.txt'.format(master_path),dtype=None,names=True)
